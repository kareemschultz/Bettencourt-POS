...
5. Click **Save as Draft** or **Send** to issue it immediately

### Recording a Payment
1. Find the invoice in the table
2. Click the **•••** menu → **Record Payment**
...
2. Select the original invoice (optional but recommended)
3. Add line items describing the adjustment
4. Click **Save** (creates in Draft status)
