---
title: Expenses
description: Track daily business expenses with full detail — supplier, category, payment method, receipt photo, reference number, and notes. Filter, export CSV, and print branded PDF reports. Smart features include duplicate detection and auto-categorization.
---
