...
4. Adjust tax rate, tax mode, and discount in the settings bar
5. Add Terms & Conditions and Notes (optional)
6. Enter **Prepared By** (your name) — appears on the PDF
7. Click **Create**
...
Click any quotation row to open the detail panel on the right. From there you can:
...
4. Add line items
5. Adjust tax rate, discount, and payment terms
6. Add **Prepared By** name (optional)
7. Click **Create**
