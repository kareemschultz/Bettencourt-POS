...
async function seed() {
	...
	// 19i. Extended Orders (days 13-30 for analytics coverage)
	// NOTE: ORDER_EXT.e1–e8 are reserved for combo/modifier/USD orders seeded later.
	...
	// NOTE: PM_EXT(1)–PM_EXT(8) are reserved for payments on e1–e8 (combo/modifier/USD orders seeded later).
	await db
		.insert(schema.payment)
		.values([
			{
